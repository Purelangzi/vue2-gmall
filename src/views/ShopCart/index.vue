      ...
      <div class="cart-body">
        <ul class="cart-list" v-for="cartInfo in cartInfoList" :key="cartInfo.id">
          ...
          <li class="cart-list-con5">
            <a href="javascript:void(0)" class="mins" @click="handle('minus',-1,cartInfo)">-</a>
            <input autocomplete="off" type="text" @change="handle('change',$event.target.value*1,cartInfo)" :value="cartInfo.skuNum" minnum="1" class="itxt">
            <a href="javascript:void(0)" @click="handle('add',1,cartInfo)" class="plus">+</a>
          </li>
